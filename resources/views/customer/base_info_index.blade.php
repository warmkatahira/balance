        ...
        <div class="py-5 mx-5 grid grid-cols-12">
            <div class="col-span-6">
                <div class="col-span-12 grid grid-cols-12">
                    ...
                    <input type="tel" id="monthly_storage_expenses" name="monthly_storage_expenses" class="col-span-2 text-sm text-right mt-2" value="{{ $customer->monthly_storage_expenses }}" autocomplete="off"><span class="mt-5 ml-1">円</span>
                    <p class="col-start-1 col-span-3 font-bold mt-4">稼働日数</p>
                    <input type="tel" id="working_days" name="working_days" class="col-span-2 text-sm text-right mt-2" value="{{ $customer->working_days }}" autocomplete="off"><span class="mt-5 ml-1">日</span>
