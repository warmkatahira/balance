    ...
    <div class="py-5 mx-5 grid grid-cols-12">
        ...
        <div class="col-span-4 text-sm">
            ...
            <div class="grid grid-cols-12 py-3 border-b-2 border-gray-400 bg-orange-200 text-base font-bold">
                ...
                <p class="col-start-9 col-span-3 text-right">{{ number_format($fare_amount_sum + $cargo_handling_amount_sum + $balance->storage_fee) }}円</p>
            </div>
            <div class="grid grid-cols-12 py-2 bg-gray-600 text-white text-base font-bold mt-5">
            ...
            @if(count($balance_labor_costs))
                ...
                <div class="grid grid-cols-12 pt-2">
                    @foreach($balance_labor_costs as $balance_labor_cost)
                        <p class="col-start-2 col-span-3">{{ $balance_labor_cost->labor_cost_category }}</p>
            ...
            @if(count($balance_other_expenses))
                ...
                <div class="grid grid-cols-12 pt-2">
                    @foreach($balance_other_expenses as $balance_other_expense)
                        <p class="col-start-2 col-span-7">{{ $balance_other_expense->expense_name }}</p>
                        <p class="col-start-9 col-span-3 text-right">{{ number_format($balance_other_expense->expense_amount) }}円</p>
                        <!-- 合計を加算 -->
                        <?php
                            $other_expense_amount_sum += $balance_other_expense->expense_amount;
                        ?>
                    @endforeach
                </div>
                <div class="grid grid-cols-12 py-1 border-y-2 border-gray-400 bg-yellow-200">
                    <p class="col-start-2 col-span-3">合計</p>
                    <p class="col-start-9 col-span-3 text-right">{{ number_format($other_expense_amount_sum) }}円</p>
                </div>
                <!-- 経費合計 -->
                <div class="grid grid-cols-12 py-3 border-b-2 border-gray-400 bg-orange-200 text-base font-bold">
                    <p class="col-start-2 col-span-3">経費合計</p>
                    <p class="col-start-9 col-span-3 text-right">{{ number_format($fare_amount_sum + $labor_costs_sum + $other_expense_amount_sum) }}円</p>
                </div>
                <div class="grid grid-cols-12 py-2 bg-gray-600 text-white text-base font-bold mt-5">
            ...
            @endif
            <!-- その他 -->
            <div class="grid grid-cols-12 pt-2 border-b-2 border-gray-400">
        ...
        <div class="col-span-7">
            <div class="col-span-12 grid grid-cols-12">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg col-span-6">
