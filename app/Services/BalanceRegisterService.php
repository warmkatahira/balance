            ...
            for($i = 0; $i < count($req_param['shipping_method_name_sales']); $i++) {
                if(!is_null($req_param['fare_amount_sales'][$i]) && $req_param['fare_amount_sales'][$i] != 0){
                    $param = [
                        ...
                        'shipping_method_note' => $req_param['shipping_method_note_sales'][$i],
        ...
        if(isset($req_param['shipping_method_name_expenses'])){
            for($i = 0; $i < count($req_param['shipping_method_name_expenses']); $i++) {
                $param = [
                    ...
                    'shipping_method_note' => $req_param['shipping_method_note_expenses'][$i],
