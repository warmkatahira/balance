...
(() => {
/*!**************************************************!*\
  !*** ./resources/js/monthly_expenses_setting.js ***!
  \**************************************************/
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
// 月額経費設定登録モーダルを開く
$("[id=monthly_expenses_setting_register_modal_open]").on("click", function () {
  var modal = document.getElementById('monthly_expenses_setting_register_modal');
...
$("[id=monthly_expenses_setting_register_enter]").on("click", function () {
  ...
  try {
    ...
    var monthly_expenses_setting_register_form = document.getElementById('monthly_expenses_setting_register_form');
    var result = window.confirm('月額経費設定を実行しますか？'); // 「はい」が押下されたらsubmit、「いいえ」が押下されたら処理キャンセル
