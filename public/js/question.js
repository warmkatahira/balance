...
$("[class^=question_detail]").on("click", function () {
  var element = document.getElementById('summary_' + $(this).attr('id')); // アイコンを切り替える
...
$(document).on("click", ".question_delete", function () {
  var result = window.confirm('よくある質問を削除しますか？'); // 「はい」が押下されたらsubmit、「いいえ」が押下されたら処理キャンセル
...
$("[id=question_register_modal_open]").on("click", function () {
  var modal = document.getElementById('question_register_modal');
...
$("[id=question_register]").on("click", function () {
  ...
  try {
    ...
    var question_register_form = document.getElementById('question_register_form');
    var result = window.confirm('よくある質問を投稿しますか？'); // 「はい」が押下されたらsubmit、「いいえ」が押下されたら処理キャンセル
