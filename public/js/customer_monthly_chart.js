...
window.onload = function () {
  ...
  $.ajax({
    ...
    success: function success(data) {
      // 日別チャートを表示
      var salesContext_daily = document.querySelector("#sales_chart_daily").getContext('2d'); // 前回のチャートを破棄
      ...
      var salesContext_monthly = document.querySelector("#sales_chart_monthly").getContext('2d'); // 前回のチャートを破棄
      ...
      var expensesContext_monthly = document.querySelector("#expenses_chart_monthly").getContext('2d'); // 前回のチャートを破棄
