...
(() => {
/*!*****************************************!*\
  !*** ./resources/js/shipping_method.js ***!
  \*****************************************/
...
$("[id=shipping_method_register_enter]").on("click", function () {
  ...
  var shipping_method_register_form = document.getElementById('shipping_method_register_form');
  ...
  try {
    ...
    var result = window.confirm('配送方法登録を実行しますか？'); // 「はい」が押下されたらsubmit、「いいえ」が押下されたら処理キャンセル
