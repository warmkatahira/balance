...
$("[id=cargo_handling_register]").on("click", function () {
  ...
  try {
    ...
    cargo_handling_unit_price_input.readOnly; // 荷役単価のtdタグにinputタグを追加

    cargo_handling_unit_price_td.append(cargo_handling_unit_price_input); // 収支登録初期表示のtdタグを作成
...
$("[id=shipping_method_register]").on("click", function () {
  ...
  try {
    ...
    shipping_method_tr.id = 'tr_' + shipping_method_select.value; // 運送会社のtdタグを作成
    ...
    shipping_method_tr.append(shipping_company_td, shipping_method_td, fare_unit_price_td, fare_expense_td, shipping_method_delete_btn_td); // trタグをtbodyタグに追加
