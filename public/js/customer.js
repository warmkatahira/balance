...
$("[id=cargo_handling_register]").on("click", function () {
  ...
  var balance_register_default_disp = document.getElementById('balance_register_default_disp'); // 作成した要素の追加先を取得
  ...
  try {
    ...
    cargo_handling_tr.id = 'tr_' + cargo_handling_select.value; // 荷役名のtdタグを作成
    ...
    cargo_handling_name_td.classList.add('p-1', 'px-2', 'border'); // 荷役単価のtdタグを作成
    ...
    cargo_handling_unit_price_input.value = cargo_handling_unit_price.value; // 荷役単価のtdタグにinputタグを追加
    ...
    cargo_handling_tr.append(cargo_handling_name_td, cargo_handling_unit_price_td, balance_register_default_disp_td, cargo_handling_delete_btn_td); // trタグをtbodyタグに追加
