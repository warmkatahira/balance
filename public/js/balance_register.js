...
(() => {
/*!******************************************!*\
  !*** ./resources/js/balance_register.js ***!
  \******************************************/
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
var fare_list_sales = document.getElementById('fare_list_sales'); // 要素追加先のDivタグ

var fare_list_expenses = document.getElementById('fare_list_expenses'); // 要素追加先のDivタグ

var shipping_method_select = document.getElementById('shipping_method_select'); // 配送方法選択のセレクトボックス

var customer_select = document.getElementById('customer_select'); // 荷主選択のセレクトボックス

var cargo_handling_select = document.getElementById('cargo_handling_select'); // 荷役選択のセレクトボックス

var cargo_handling_list = document.getElementById('cargo_handling_list'); // 要素追加先のDivタグ

var total_fare_sales_div = document.getElementById('total_fare_sales_div'); // 運賃関連の合計divタグ

var total_fare_expenses_div = document.getElementById('total_fare_expenses_div'); // 運賃関連の合計divタグ

var total_box_quantity_sales = document.getElementById('total_box_quantity_sales'); // 個口合計のpタグ

var total_fare_sales = document.getElementById('total_fare_sales'); // 運賃金額合計のpタグ

var total_box_quantity_expenses = document.getElementById('total_box_quantity_expenses'); // 個口合計のpタグ

var total_fare_expenses = document.getElementById('total_fare_expenses'); // 運賃金額合計のpタグ

var total_cargo_handling_div = document.getElementById('total_cargo_handling_div'); // 運賃関連の合計divタグ

var total_operation_quantity = document.getElementById('total_operation_quantity'); // 作業数合計のpタグ

var total_cargo_handling = document.getElementById('total_cargo_handling'); // 荷役金額合計のpタグ

var storage_fee = document.getElementById('storage_fee'); // 保管費のinputタグ

var total_storage_fee = document.getElementById('total_storage_fee'); // 保管金額合計のpタグ

var total_working_time = document.getElementById('total_working_time'); // 労働時間合計のpタグ

var total_labor_costs = document.getElementById('total_labor_costs'); // 人件費合計のpタグ

var other_expenses_select = document.getElementById('other_expenses_select'); // その他経費選択のセレクトボックス

var other_expenses_list = document.getElementById('other_expenses_list'); // 要素追加先のDivタグ

var total_other_expenses_div = document.getElementById('total_other_expenses_div'); // その他経費の合計divタグ

var total_other_expenses_amount = document.getElementById('total_other_expenses_amount'); // その他経費金額合計のpタグ

var storage_fee_detail = document.getElementById('storage_fee_detail'); // 保管費の詳細を表示するpタグ

var other_sales_select = document.getElementById('other_sales_select'); // その他売上選択のセレクトボックス

var other_sales_list = document.getElementById('other_sales_list'); // 要素追加先のDivタグ

var total_other_sales_div = document.getElementById('total_other_sales_div'); // その他売上の合計divタグ

var total_other_sales_amount = document.getElementById('total_other_sales_amount'); // その他売上金額合計のpタグ
// 登録用のモーダルを開く
...
$("[id=shipping_method_add]").on("click", function () {
  // 選択した配送方法のidとなる値
  var select_id = shipping_method_select.value; // 選択しているインデックス番号を取得

  var select_index = shipping_method_select.selectedIndex;
...
function fare_add(add_category, select_id, select_shipping_method, select_price) {
  ...
  box_quantity.classList.add('text-sm', 'col-span-1', 'text-right', 'fare_amount_' + add_category + '_update', 'h-4/5', 'box_quantity_' + add_category, 'int_validation'); // 個口数という文字を表示する要素を作成

  var box_quantity_text = document.createElement('p');
  box_quantity_text.classList.add('text-sm', 'col-span-1', 'text-left', 'pt-5', 'ml-2');
  box_quantity_text.innerHTML = '個口'; // ×を表示する要素を作成

  var symbol_kakeru = document.createElement('p');
  symbol_kakeru.classList.add('text-base', 'col-span-1', 'py-3');
  symbol_kakeru.innerHTML = '<i class="las la-times"></i>'; // 運賃単価を表示・入力する要素を作成
  ...
  fare_unit_price.classList.add('text-sm', 'col-span-1', 'text-right', 'fare_amount_' + add_category + '_update', 'h-4/5', 'int_validation'); // 円という文字を表示する要素を作成

  var fare_unit_price_text = document.createElement('p');
  fare_unit_price_text.classList.add('text-sm', 'col-span-1', 'text-left', 'pt-5', 'ml-2');
  fare_unit_price_text.innerHTML = '円'; // =を表示する要素を作成

  var symbol_equal = document.createElement('p');
  symbol_equal.classList.add('text-base', 'col-span-1', 'py-3');
  symbol_equal.innerHTML = '<i class="las la-equals"></i>'; // 金額を表示・入力する要素を作成
  ...
  fare_amount.classList.add('text-sm', 'col-span-2', 'text-right', 'h-4/5', 'fare_amount_' + add_category, 'int_validation'); // 削除ボタンの要素を作成
...
$(document).on("click", ".delete_shipping_method_sales", function () {
  ...
  var delete_target_div_sales = document.getElementById(target_id + '_fare_sales_div');
  var delete_target_div_expenses = document.getElementById(target_id + '_fare_expenses_div');
...
$(document).on("change", ".fare_amount_sales_update", function () {
  var target_id = id_get($(this));
  var target_box_quantity_sales = document.getElementById(target_id + '_box_quantity_sales');
  var target_fare_unit_price_sales = document.getElementById(target_id + '_fare_unit_price_sales');
  var target_fare_amount_sales = document.getElementById(target_id + '_fare_amount_sales');
...
function fare_amount_expenses_update(target_id) {
  var target_box_quantity_expenses = document.getElementById(target_id + '_box_quantity_expenses');
  var target_fare_unit_price_expenses = document.getElementById(target_id + '_fare_unit_price_expenses');
  var target_fare_amount_expenses = document.getElementById(target_id + '_fare_amount_expenses');
...
function total_fare_expenses_update() {
  ...
  for (var _i2 = 0; _i2 < fare_amount_element.length; _i2++) {
    fare_amount_sum += isNaN(fare_amount_element[_i2].value) ? 0 : Number(fare_amount_element[_i2].value);
  }
...
$("[id=customer_select]").on("change", function () {
  ...
  $.ajax({
    ...
    success: function success(data) {
      ...
      storage_fee_detail.innerHTML = (data['customer']['monthly_storage_fee'] !== null ? data['customer']['monthly_storage_fee'] + '円 / ' : '設定なし / ') + (data['customer']['working_days'] !== null ? data['customer']['working_days'] + '日 = ' : '設定なし = ') + data['storage_fee'].toLocaleString() + '円'; // 保管費を出力
...
$("[id=cargo_handling_add]").on("click", function () {
  ...
  try {
    ...
    var select_value_split = cargo_handling_select.options[select_index].innerHTML.split('(単価:'); // スプリットした値を変数に格納

    var cargo_handling_name_value = select_value_split[0];
...
function cargo_handling_add(add_id, cargo_handling_name_value, cargo_handling_unit_price_value) {
  // 荷役を表示する要素を作成
  var cargo_handling_name = document.createElement('input');
  ...
  operation_quantity.classList.add('text-sm', 'col-span-1', 'text-right', 'cargo_handling_amount_update', 'h-4/5', 'operation_quantity', 'int_validation'); // 作業という文字を表示する要素を作成

  var operation_quantity_text = document.createElement('p');
  operation_quantity_text.classList.add('text-sm', 'col-span-1', 'text-left', 'pt-5', 'ml-2');
  operation_quantity_text.innerHTML = '作業'; // ×を表示する要素を作成

  var symbol_kakeru = document.createElement('p');
  symbol_kakeru.classList.add('text-base', 'col-span-1', 'py-3');
  symbol_kakeru.innerHTML = '<i class="las la-times"></i>'; // 荷役単価を表示・入力する要素を作成
  ...
  cargo_handling_unit_price.classList.add('text-sm', 'col-span-1', 'text-right', 'cargo_handling_amount_update', 'h-4/5', 'int_validation'); // 円という文字を表示する要素を作成

  var cargo_handling_unit_price_text = document.createElement('p');
  cargo_handling_unit_price_text.classList.add('text-sm', 'col-span-1', 'text-left', 'pt-5', 'ml-2');
  cargo_handling_unit_price_text.innerHTML = '円'; // =を表示する要素を作成
  ...
  cargo_handling_amount.classList.add('text-sm', 'col-span-2', 'text-right', 'h-4/5', 'cargo_handling_amount', 'int_validation'); // 削除ボタンの要素を作成
  ...
  var clone_cargo_handling_unit_price_text = cargo_handling_unit_price_text.cloneNode(true); // 追加する要素を纏めるdivタグを作成
  ...
  target_div.append(cargo_handling_name, operation_quantity, operation_quantity_text, symbol_kakeru, cargo_handling_unit_price, cargo_handling_unit_price_text, symbol_equal, cargo_handling_amount, clone_cargo_handling_unit_price_text, delete_btn); // 纏めたdivタグを追加
...
$(document).on("change", ".cargo_handling_amount_update", function () {
  var target_id = id_get($(this));
  var target_operation_quantity = document.getElementById(target_id + '_operation_quantity');
  var target_cargo_handling_unit_price = document.getElementById(target_id + '_cargo_handling_unit_price');
  var target_cargo_handling_amount = document.getElementById(target_id + '_cargo_handling_amount');
...
$(document).on("change", ".labor_costs_update", function () {
  var target_id = id_get($(this));
  var target_working_time = document.getElementById(target_id + '_working_time');
  var target_hourly_wage = document.getElementById(target_id + '_hourly_wage');
  var target_labor_costs = document.getElementById(target_id + '_labor_costs');
...
function id_get(target) {
  var split = target.attr('id').split('_');
  return split[0];
} // その他経費の追加ボタンが押下されたら
...
$("[id=other_expenses_add]").on("click", function () {
  // 選択した荷役のidとなる値
  var select_id = other_expenses_select.value; // 選択しているインデックス番号を取得

  var select_index = other_expenses_select.selectedIndex; // 選択した経費の値を取得

  var select_value = other_expenses_select.options[select_index].innerHTML;
  ...
  try {
    ...
    var other_expenses_name = document.createElement('input');
    ...
    other_expenses_name.name = 'other_expenses_name[]'; // 経費金額を入力する要素を作成

    var other_expenses_amount = document.createElement('input');
    ...
    other_expenses_amount.classList.add('text-sm', 'col-span-2', 'col-start-9', 'text-right', 'other_expenses_amount_update', 'h-4/5', 'other_expenses_amount', 'int_validation'); // 円という文字を表示する要素を作成

    var other_expenses_amount_text = document.createElement('p');
    other_expenses_amount_text.classList.add('text-sm', 'col-span-1', 'col-start-11', 'text-left', 'pt-5', 'ml-2');
    other_expenses_amount_text.innerHTML = '円'; // 削除ボタンの要素を作成

    var delete_btn = document.createElement('button');
    delete_btn.type = 'button';
    delete_btn.id = select_value + '_other_expenses_delete_btn';
    delete_btn.innerHTML = '<i class="las la-trash la-lg"></i>';
    delete_btn.classList.add('col-span-1', 'col-start-12', 'bg-red-600', 'text-white', 'hover:bg-gray-400', 'delete_other_expenses', 'h-4/5'); // 追加する要素を纏めるdivタグを作成
    ...
    target_div.append(other_expenses_name, other_expenses_amount, other_expenses_amount_text, delete_btn); // 纏めたdivタグを追加
...
$(document).on("click", ".delete_other_expenses", function () {
  var target_id = id_get($(this));
  var delete_target_div = document.getElementById(target_id + '_other_expenses_div');
  delete_target_div.remove();
  total_other_expenses_update();
}); // その他経費の合計金額更新処理
...
$("[id=other_sales_add]").on("click", function () {
  // 選択した荷役のidとなる値
  var select_id = other_sales_select.value; // 選択しているインデックス番号を取得
  ...
  try {
    ...
    var other_sales_name = document.createElement('input');
    ...
    other_sales_name.name = 'other_sales_name[]'; // 売上金額を入力する要素を作成
    ...
    other_sales_amount_text.innerHTML = '円'; // 削除ボタンの要素を作成

    var delete_btn = document.createElement('button');
    delete_btn.type = 'button';
    delete_btn.id = select_value + '_other_sales_delete_btn';
    delete_btn.innerHTML = '<i class="las la-trash la-lg"></i>';
    delete_btn.classList.add('col-span-1', 'col-start-12', 'bg-red-600', 'text-white', 'hover:bg-gray-400', 'delete_other_sales', 'h-4/5'); // 追加する要素を纏めるdivタグを作成

    var target_div = document.createElement('div');
    target_div.id = select_value + '_other_sales_div';
    target_div.classList.add('grid', 'grid-cols-12', 'col-span-12', 'border-b-2', 'border-black', 'pt-2'); // divタグに作成した要素を追加

    target_div.append(other_sales_name, other_sales_amount, other_sales_amount_text, delete_btn); // 纏めたdivタグを追加
...
$(document).on("click", ".delete_other_sales", function () {
  var target_id = id_get($(this));
  var delete_target_div = document.getElementById(target_id + '_other_sales_div');
  delete_target_div.remove();
  total_other_sales_update();
}); // その他売上の合計金額更新処理
...
function validation($msg) {
  ...
  try {
    ...
    var int_validations = document.querySelectorAll('.int_validation');
    int_validations.forEach(function (int_validation) {
      // 時給が正しいかチェック
      if (isNaN(int_validation.value)) {
        throw new Error('入力が正しくありません。');
      }
    });
    var result = window.confirm($msg); // 「はい」が押下されたらsubmit、「いいえ」が押下されたら処理キャンセル
