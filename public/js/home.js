...
var progress_per = document.getElementById('progress_per');
var amber = 'rgba(255, 160, 0, 1)';
...
window.onload = function () {
  ...
  $.ajax({
    ...
    success: function success(data) {
      // 進捗チャートを表示
      var progressContext = document.querySelector("#progress_chart").getContext('2d'); // 前回のチャートを破棄
